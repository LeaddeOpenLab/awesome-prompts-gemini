...
**27** Prompts · Última adição: **2026-09-22**

<a name="catalog"></a>

## Explorar por categoria

[Fotografia](#category-photography) · [Cinematográfico / Imagem de Filme](#category-cinematic-film-still) · [Anime / Mangá](#category-anime-manga) · [Ilustração](#category-illustration) · [Renderização 3D](#category-3d-render) · [Outros](#category-other)
...
### A câmera avança suavemente em macro pela xícara de café, penetra a superfície do líquido e entra em uma cidade futurista em miniatura dentro da xícara.
...
Cinematográfico / Imagem de Filme · Cyberpunk / Ficção Científica · Alimentos / Bebidas · Paisagem Urbana / Rua · Publicado

**Resumo:** A câmera avança suavemente em macro pela xícara de café, penetra a superfície do líquido e entra em uma cidade futurista em miniatura dentro da xícara.
...
```text
Uma tomada macro cinematográfica e fotorrealista de uma xícara fumegante de café preto encorpado sobre uma mesa de café moderna e elegante. 0–2 seg: A câmera avança lentamente em direção à superfície do café, capturando vapor realista, reflexos e minúsculas ondulações. 2–5 seg: A câmera dá um zoom dramático direto para dentro do café, atravessando a superfície líquida brilhante em uma transição suave e contínua. 5–8 seg: Revela-se uma surpreendente e minúscula cidade futurista escondida dentro da xícara de café — arranha-céus imponentes e iluminados, ruas em miniatura, carros em movimento, pedestres pequeninos, letreiros brilhantes e rodovias elevadas. 8–10 seg: A câmera voa entre os edifícios em miniatura enquanto veículos voadores elegantes cruzam o horizonte futurista, com pequenas aeronaves deixando sutis rastros de luz.
Escala em miniatura ultrarrealista, profundidade de campo cinematográfica, iluminação volumétrica, reflexos realistas, arquitetura detalhada, movimento dinâmico de câmera, transição contínua de macro para grande-angular, detalhes em 8K, texturas fotorrealistas, atmosfera futurista, movimento fluido, sem cortes, sem texto, sem marca d'água, visualmente espetacular.
```
...
### Prompt JSON de 10s direcionando raios e fragmentos de carbono para se montarem em um Lamborghini Aventador em uma passagem montanhosa tempestuosa.

Autor：[@MrDasCreates](https://x.com/MrDasCreates) · [Publicação original](https://x.com/MrDasCreates/status/2099517007934919019)

Cinematográfico / Imagem de Filme · Paisagem / Natureza · Publicado

**Resumo:** Prompt JSON de 10s direcionando raios e fragmentos de carbono para se montarem em um Lamborghini Aventador em uma passagem montanhosa tempestuosa.
...
```text
{
  ...
  "shot": {
    ...
    "composition": "começa em plano ultra-aberto em uma passagem de montanha açoitada pela tempestade ao entardecer, segue fragmentos de fibra de carbono e energia de relâmpagos girando até tomar forma, termina em um close-up centralizado de um Lamborghini Aventador rugindo",
    "lens": "grande-angular para a paisagem épica, depois 35mm para a revelação do produto",
    "frame_rate": "cinematográfico a 24fps",
    "camera_movement": "lento e dramático avanço através da tempestade seguindo os fragmentos que sobem, depois um dolly baixo e agressivo enquanto eles se encaixam no carro, mantendo-se estável enquanto ele se assenta e acelera"
  },
  "timeline": {
    "0-3s": "Vasta passagem montanhosa italiana sob tempestade ao entardecer. Picos escarpados, asfalto molhado e sinuoso, nuvens escuras rasgadas por relâmpagos distantes. Chuva fustigada pelo vento e névoa sobre penhascos rochosos.",
    "3-7s": "Centenas de fragmentos afiados de fibra de carbono, painéis metálicos brilhantes e feixes de energia azul-elétrica erguem-se da estrada e giram em órbitas violentas e precisas. Eles se interligam no ar na silhueta angular exata de um Lamborghini Aventador. Faíscas, refração da chuva e bordas crepitantes de energia.",
    "7-10s": "A forma pulsa com uma onda de luz e se materializa em um Lamborghini Aventador preto-fosco real, pairando e depois pousando sobre a pista molhada. Faróis acendem intensamente, portas tesoura se erguem ligeiramente, motor ruge. Fixa na fera enquanto a chuva escorre pela carroceria."
  },
  "subject": {
    "description": "centenas de fragmentos de fibra de carbono e estilhaços de energia subindo e colidindo em órbitas agressivas para formar a silhueta de um supercarro",
    "props": "Lamborghini Aventador final formado a partir de fragmentos em turbilhão, depois fazendo a transição para um supercarro de marca real enquanto se assenta na estrada"
  },
  "scene": {
    "location": "passagem dramática em alta montanha com estrada sinuosa e molhada",
    "time_of_day": "entardecer tempestuoso, última luz dourada rompendo as nuvens escuras, clarões de relâmpagos",
    "environment": "clima alpino implacável, asfalto escorregadio pela chuva, rochas pontiagudas, vento uivante"
  },
  "visual_details": {
    "action": "fragmentos se erguem, giram em trajetórias violentas e organizadas, encaixam-se no contorno do carro, pulsam com energia, e então se transformam no Aventador finalizado que cai e acelera",
    "special_effects": "animação de partículas de carbono, rastros de energia de relâmpagos, metamorfose de material no ar, interação com a chuva, distorção de calor do motor e spray dos pneus"
  },
  "cinematography": {
    "lighting": "iluminação dramática de tempestade com frestas da hora dourada, brilhos de energia azul-elétrica, luz de contorno nítida na carroceria de carbono molhada",
    "color_palette": "pretos foscos, cinzas de tempestade, azuis elétricos, reflexos no asfalto molhado, dourado quente do entardecer",
    "tone": "força bruta, fúria italiana, luxo épico"
  },
  "audio": {
    "music": "tambores cinematográficos profundos e golpes orquestrais agressivos com tensão crescente",
    "ambient": "vento de montanha uivante, trovão distante, chuva na estrada",
    "sound_effects": "estalos metálicos e de carbono afiados conforme as peças se encaixam, estrondo massivo do V12 quando a forma se completa, rosnado dos pneus e chiado da chuva",
    "mix": "poderosa, trovejante, natureza contra máquina com um centro musical dinâmico"
  },
  "constraints": {
    "dialogue": "none",
    "voiceover": "none",
...
Cinematográfico / Imagem de Filme · Renderização 3D · Personagem · Texto / Tipografia · Publicado
...
### Um prompt para um vídeo cinematográfico ultrarrealista de 10 segundos retratando uma cena em miniatura no interior de uma gigantesca fábrica de bolos, onde confeiteiros pequeninos trabalham juntos para decorar um enorme bolo de aniversário de vários andares.
...
**Resumo:** Um prompt para um vídeo cinematográfico ultrarrealista de 10 segundos retratando uma cena em miniatura no interior de uma gigantesca fábrica de bolos, onde confeiteiros pequeninos trabalham juntos para decorar um enorme bolo de aniversário de vários andares.
...
```text
Crie um vídeo cinematográfico em miniatura ultrarrealista de 10 segundos ambientado no interior de uma fábrica de bolos gigantesca e mágica. Confeiteiros minúsculos vestindo uniformes brancos de chef e pequenos chapéus de padeiro trabalham juntos para decorar um bolo de aniversário imenso de vários andares que se ergue imponente sobre eles.
0–3 seg: Plano geral introdutório do bolo enorme sobre uma mesa de fábrica, com confeiteiros minúsculos subindo em escadas e carregando ferramentas coloridas de glacê.
...
### Instruções de animação no estilo jogo de papel 2D mantendo o personagem de desenho infantil.
...
**Resumo:** Instruções de animação no estilo jogo de papel 2D mantendo o personagem de desenho infantil.
...
```text
Não alterar nem descaracterizar o personagem anexado, mantê-lo exatamente como está.\nJogo de papel 2D.
```
...
### Construir uma linda borboleta mecânica no Three.js.
...
**Resumo:** Construir uma linda borboleta mecânica no Three.js.
...
### Criar um asset 3D do robô WALL-E usando o Three.js.
...
**Resumo:** Criar um asset 3D do robô WALL-E usando o Three.js.
...
```text
crie um modelo 3d do wall-e no three.js.
```
...
```text
crie uma linda borboleta mecânica no three.js
```
...
### Prompt para gerar um dragão 3D interativo em um fundo branco usando Three.js.
...
**Resumo:** Prompt para gerar um dragão 3D interativo em um fundo branco usando Three.js.
...
```text
crie um dragão 3D usando three.js, use um fundo de tema branco para que o objeto principal fique visível
```
  ...
  "sequence": [
    {
      ...
      "camera": "Plano aéreo cinematográfico aberto com aproximação (push-in)",
      "action": "Uma enorme pizza recém-assada repousa sobre uma mesa de madeira como um canteiro de obras maciço. Dezenas de operários minúsculos chegam correndo com carregadeiras, guindastes, caminhões de entrega e equipamentos em miniatura, preparando-se para construir a pizza perfeita.",
      "sound_design": "Música alegre e animada, barulhos de pequenos motores, rodas girando, atividade sutil de construção."
    },
    {
      "time": "2-4 seg",
      "scene": "Camada de Molho e Queijo",
      "camera": "Plano médio com acompanhamento lateral",
      "action": "Um food truck em miniatura bombeia um rico molho de tomate vermelho sobre a pizza enquanto operários minúsculos o espalham suavemente com pequenas espátulas. Outra equipe vem logo atrás, cobrindo a superfície com uma grossa camada de muçarela ralada.",
      "sound_design": "Som suave de molho sendo despejado, raspagem de espátula, queijo farfalhando, música rítmica alegre."
    },
    {
      "time": "4-6 seg",
      "scene": "Ingredientes em Movimento",
      "camera": "Close-up macro com suave câmera lenta",
      "action": "Pequenas esteiras rolantes transportam ingredientes coloridos, incluindo pepperoni, cogumelos, pimentões, azeitonas e manjericão fresco. Os operários em miniatura organizam cuidadosamente cada cobertura sobre a superfície de queijo com precisão.",
      "sound_design": "Movimento de esteira rolante, pequenas quedas de ingredientes, delicados sinos mágicos, toques musicais animados."
    },
    {
      "time": "6-8 seg",
      "scene": "Elevação do Ingrediente Final",
      "camera": "Plano contra-plongée dramático e cinematográfico",
      "action": "Um guindaste em miniatura levanta uma fatia gigante de pepperoni em direção ao centro da pizza. Operários abaixo puxam cordas de guia e sinalizam uns para os outros enquanto o ingrediente é posicionado lentamente no lugar.",
      "sound_design": "Pequeno motor de guindaste, sons de tensão de cordas, cliques mecânicos, música orquestral cinematográfica crescente."
    },
    {
      "time": "8-10 seg",
      "scene": "Grande Final da Pizza",
      "camera": "Close-up orbital suave em 360 graus",
      "action": "O último ingrediente cai perfeitamente na posição. Uma chuva de confetes coloridos preenche o mundo em miniatura enquanto os pequenos trabalhadores comemoram e festejam. A câmera gira em torno da pizza finalizada, revelando seu queijo derretido brilhante, coberturas coloridas e crosta dourada antes de terminar em uma tomada heroica e satisfatória.",
      "sound_design": "Estouro comemorativo, aplausos alegres, pequenos apitos, final orquestral edificante."
    }
  ],
  "visual_style": {
    "animation_quality": "Animação 3D de alta qualidade inspirada na Pixar",
    "world_design": "Encantador mundo de construção em miniatura construído ao redor de uma pizza gigante",
    "color_palette": "Vermelhos quentes, marrons dourados, tons cremosos de queijo e coberturas brilhantes e coloridas",
    "lighting": "Iluminação dourada quente e suave com realces cinematográficos sutis",
    "detail": "Texturas de comida altamente detalhadas, maquinário em miniatura, derretimento de queijo realista, coberturas crocantes e pequenos personagens expressivos",
    "camera": "Movimento cinematográfico fluido, sensação de macrofotografia, transições suaves, profundidade de campo rasa",
    "overall_feel": "Fofo, divertido, visualmente satisfatório, polido, refinado e fantasioso",
    "resolution": "720p"
  }
}
```
...
### Uma obra de arte digital surrealista de um jovem de moletom amarelo sentado em uma nuvem.
...
**Resumo:** Uma obra de arte digital surrealista de um jovem de moletom amarelo sentado em uma nuvem.
...
```text
Uma obra de arte digital surrealista de um jovem sentado confortavelmente em uma nuvem branca e fofa bem alto no céu, vestindo um moletom com capuz amarelo, calça jogger azul, tênis vermelhos e brancos e um boné em tons pastel.
```
...
### Transformação em time-lapse de um terreno vazio em uma mansão moderna de luxo com piscina de borda infinita sob iluminação variável.
...
**Resumo:** Transformação em time-lapse de um terreno vazio em uma mansão moderna de luxo com piscina de borda infinita sob iluminação variável.
...
```text
Crie um vídeo cinematográfico em time-lapse ultrarrealista de 10 segundos mostrando um canteiro de obras de luxo vazio se transformando rapidamente em uma mansão ultramoderna deslumbrante. Comece com um pedaço de terreno ajardinado completamente vazio sob uma iluminação dramática de hora dourada. Em uma sequência de construção incrivelmente rápida e fluida, a fundação se forma a partir do solo, estruturas reforçadas erguem-se para cima, paredes elegantes se montam, enormes janelas de vidro do chão ao teto deslizam perfeitamente para o lugar e um sofisticado telhado plano se completa. Uma impressionante piscina de borda infinita se materializa ao lado da casa enquanto caminhos de pedra e um grande terraço se formam ao redor dela. Gramados verdes exuberantes, árvores perfeitamente aparadas, plantas ornamentais e iluminação paisagística sutil surgem rapidamente. Por fim, toda a propriedade se torna uma mansão arquitetônica de ultraluxo finalizada, apresentando iluminação interna acolhedora, paredes de vidro panorâmicas, uma piscina de borda infinita refletindo o pôr do sol, paisagismo elegante e uma entrada de garagem moderna e sofisticada. Termine com um lento avanço cinematográfico da câmera em direção à mansão concluída. Materiais fotorrealistas, física de construção realista, montagem suave de objetos, transformações perfeitas, luz solar volumétrica dramática, reflexos realistas, qualidade de visualização arquitetônica, 4K, HDR, profundidade de campo cinematográfica, sem pessoas, sem texto, sem logotipos, sem marca d'água. Ritmo acelerado, mas visualmente suave, transformação perfeitamente contínua de terreno vazio a mansão concluída.
```
