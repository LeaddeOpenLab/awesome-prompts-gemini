...
[Fotografía](#category-photography) · [Cine / Fotograma](#category-cinematic-film-still) · [Anime / Manga](#category-anime-manga) · [Ilustración](#category-illustration) · [Renderizado 3D](#category-3d-render) · [Otros](#category-other)
...
### Prompt de retrato de estilo cotidiano de una pareja joven acurrucada en interiores.

Autor：[@55hawks](https://x.com/55hawks) · [Publicación original](https://x.com/55hawks/status/2101199107914424604)

Fotografía · Retrato / Selfie · Personaje · Grupo / Pareja · Arquitectura / Interiores · Publicado

**Resumen:** Prompt de retrato de estilo cotidiano de una pareja joven acurrucada en interiores.

<img src="images/2101199107914424604-1.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
Una joven pareja de enamorados acurrucada en interiores, abrazada por la espalda, con las manos rodeando suavemente el pecho. Luz natural suave, textura de piel realista, estilo de foto de celular --ar 2:3
```
...
### Retrato de alta costura en una plataforma de observación de Tokio, con una mujer vestida con un traje sastre color crema señalando la Torre de Tokio.
...
**Resumen:** Retrato de alta costura en una plataforma de observación de Tokio, con una mujer vestida con un traje sastre color crema señalando la Torre de Tokio.
...
```text
Crea una fotografía editorial de moda de lujo de alta gama y ultrarrealista en Tokio, Japón, con luz diurna natural brillante.

Una sofisticada mujer joven está de pie en una lujosa plataforma de observación elevada en una azotea con barandilla de cristal, contemplando una impresionante vista panorámica de Tokio. Viste un elegante atuendo de lujo de color crema con un refinado blazer y pantalones de pierna ancha, con un estilo propio de una campaña de moda de primera calidad.

Lleva un bolso de mano de lujo en una mano y un moderno Apple iPhone en la otra. El brazo que sostiene el iPhone está extendido de manera natural hacia la ciudad, con el dedo índice señalando claramente hacia la Torre de Tokio, como si estuviera mostrando con elegancia el emblemático punto de referencia y la hermosa ciudad a alguien.

El horizonte de Tokio debe permanecer sumamente visible, nítido y detallado, incluyendo numerosos rascacielos, edificios, calles, vegetación y la Torre de Tokio situada de forma prominente en el fondo. La ciudad NO debe estar excesivamente borrosa. Mantén tanto a la mujer como al paisaje urbano distante visualmente claros.

Luz diurna brillante y limpia, cielo azul con nubes suaves y naturales, visibilidad atmosférica nítida, luz solar y sombras realistas, detalles arquitectónicos de primera calidad, textura de piel realista, cabello natural, manos y dedos realistas, proporciones corporales precisas, ropa y bolso detallados, estética sofisticada de viajes de lujo.
...
Estilo fotográfico: publicidad de lujo de alta gama, fotografía editorial cinematográfica, cámara profesional de formato completo (full-frame), gran profundidad de campo, primer plano y fondo nítidos, fotorrealista, ultradetallado, texturas realistas, colores naturales, calidad comercial premium, 8K.
...
Sin texto, sin marcas de agua, sin desenfoque artificial, sin manos distorsionadas, sin dedos adicionales, sin objetos duplicados, sin anatomía deformada, sin efecto de caricatura.
```
...
### Video cinematográfico macro ultrarrealista de investigadores marinos en miniatura explorando el interior de un gigantesco canal auditivo humano.

Autor：[@AiwithBloodline](https://x.com/AiwithBloodline) · [Publicación original](https://x.com/AiwithBloodline/status/2101892143560437894)

Cine / Fotograma · Paisaje / Naturaleza · Publicado

Publicación original：[@AiwithBloodline](https://x.com/AiwithBloodline) · [Publicación original](https://x.com/AiwithBloodline/status/2101618979118658038)

**Resumen:** Video cinematográfico macro ultrarrealista de investigadores marinos en miniatura explorando el interior de un gigantesco canal auditivo humano.

<img src="covers/2101892143560437894.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
Video macro cinematográfico ultrarrealista de una expedición oceánica surrealista en miniatura que tiene lugar dentro de un gigantesco oído humano. Un equipo de diminutos investigadores marinos profesionales con trajes de exploración impermeables navega por las intrincadas curvas del canal auditivo usando botes en miniatura, cuerdas de escalada, escáneres portátiles y equipo científico compacto. Las estructuras del oído interno parecen enormes como una misteriosa caverna submarina, con textura de piel realista, humedad sutil, vellos finos y detalles anatómicos naturales. Diminutos investigadores iluminan las paredes con potentes linternas frontales en miniatura mientras otro opera una pequeña sonda robótica que recolecta partículas microscópicas de un charco poco profundo de humedad. Las gotas flotantes se comportan como enormes esferas suspendidas, creando una extraña sensación de escala. Cinematografía macro extrema, profundidad de campo ultraestrecha, anatomía humana realista, iluminación dramática de laboratorio azul y blanca mezclada con cálidas luces de exploración, intrincados detalles en miniatura, reflejos y sombras físicamente precisos, movimiento de cámara cinematográfico lento que viaja a través del canal auditivo hacia las estructuras internas, texturas fotorrealistas, surrealista pero científicamente creíble, 8K, HDR, óptica realista, sin texto, sin marcas de agua. 10 segundos, vertical 9:16.
```
...
### La cámara avanza suavemente en macro hacia la taza de café, atravesando la superficie líquida para entrar en una ciudad futurista en miniatura dentro de la taza.
...
Cine / Fotograma · Cyberpunk / Ciencia ficción · Comida y bebida · Paisaje urbano / Calle · Publicado

**Resumen:** La cámara avanza suavemente en macro hacia la taza de café, atravesando la superficie líquida para entrar en una ciudad futurista en miniatura dentro de la taza.

<img src="covers/2100486977456095594.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
Una toma macro cinematográfica y fotorrealista de una taza humeante de intenso café negro sobre una elegante mesa de café moderno. 0–2 s: La cámara avanza lentamente hacia la superficie del café, capturando vapor realista, reflejos y diminutas ondas. 2–5 s: La cámara hace un zoom dramático directo hacia el café, atravesando la superficie líquida brillante en una transición fluida e imperceptible. 5–8 s: Se revela una asombrosa ciudad futurista diminuta oculta dentro de la taza de café: imponentes rascacielos iluminados, calles en miniatura, autos en movimiento, peatones diminutos, letreros brillantes y autopistas elevadas. 8–10 s: La cámara vuela entre los edificios en miniatura mientras elegantes vehículos voladores navegan por el horizonte futurista, con pequeñas aeronaves que dejan sutiles estelas de luz.
Escala en miniatura ultrarrealista, profundidad de campo cinematográfica, iluminación volumétrica, reflejos realistas, arquitectura detallada, movimiento de cámara dinámico, transición fluida de macro a panorámica, detalle 8K, texturas fotorrealistas, atmósfera futurista, movimiento suave, sin cortes, sin texto, sin marcas de agua, visualmente espectacular.
```
...
### Prompt en JSON de 10 s que dirige relámpagos y fragmentos de carbono para ensamblarse en un Lamborghini Aventador en un paso de montaña tormentoso.

Autor：[@MrDasCreates](https://x.com/MrDasCreates) · [Publicación original](https://x.com/MrDasCreates/status/2099517007934919019)

Cine / Fotograma · Paisaje / Naturaleza · Publicado

**Resumen:** Prompt en JSON de 10 s que dirige relámpagos y fragmentos de carbono para ensamblarse en un Lamborghini Aventador en un paso de montaña tormentoso.
...
```text
{
  ...
  "aspect_ratio": "16:9",
  "shot": {
    "structure": "toma única continua e ininterrumpida, sin cortes de escena",
    "composition": "comienza en plano ultra gran angular sobre un paso de montaña azotado por la tormenta al atardecer, sigue fragmentos de fibra de carbono y energía de relámpagos arremolinándose hasta tomar forma, termina en un primer plano centrado de un rugiente Lamborghini Aventador",
    "lens": "gran angular para el paisaje épico, luego 35 mm para la revelación del producto",
    "frame_rate": "24fps cinematográfico",
    "camera_movement": "acercamiento lento y dramático a través de la tormenta siguiendo los fragmentos que se elevan, luego un dolly bajo y agresivo a medida que se encastran en el automóvil, manteniéndose firme mientras se asienta y revoluciona el motor"
  },
  "timeline": {
    "0-3s": "Vasto y tormentoso paso de montaña italiano al atardecer. Picos escarpados, asfalto húmedo y sinuoso, nubes oscuras que se abren con relámpagos distantes. Lluvia y niebla azotadas por el viento sobre acantilados rocosos.",
    "3-7s": "Cientos de afilados fragmentos de fibra de carbono, paneles metálicos brillantes y estelas de energía azul eléctrico se elevan del camino y giran en órbitas violentas y precisas. Se ensamblan en el aire en la silueta angular exacta de un Lamborghini Aventador. Chispas, refracción de lluvia y bordes de energía crepitante.",
    "7-10s": "La forma pulsa con una oleada de luz y se materializa en un Lamborghini Aventador real negro mate que levita y luego cae sobre la carretera mojada. Los faros brillan con fuerza, las puertas de tijera se elevan ligeramente, el motor brama. Mantener la toma en la bestia mientras la lluvia resbala por la carrocería."
  },
  "subject": {
    "description": "cientos de fragmentos de fibra de carbono y energía que se elevan y chocan en órbitas agresivas para formar la silueta de un superdeportivo",
    "props": "Lamborghini Aventador final formado a partir de fragmentos en torbellino, luego transicionando a un superdeportivo de marca real mientras se asienta sobre la carretera"
  },
  "scene": {
    "location": "dramático paso de alta montaña con carretera sinuosa y mojada",
    "time_of_day": "atardecer tormentoso, última luz dorada filtrándose entre nubes oscuras, destellos de relámpagos",
    "environment": "clima alpino implacable, asfalto resbaladizo por la lluvia, rocas escarpadas, viento aullante"
  },
  "visual_details": {
    "action": "los fragmentos se elevan, rotan en trayectorias violentas y organizadas, encajan en la silueta del automóvil, pulsan con energía y luego se transforman en el Aventador terminado que cae y acelera",
    "special_effects": "animación de partículas de carbono, estelas de energía de relámpagos, metamorfosis de material en el aire, interacción con la lluvia, distorsión térmica del motor y salpicaduras de neumáticos"
  },
  "cinematography": {
    "lighting": "iluminación dramática de tormenta con destellos de la hora dorada, resplandores de energía azul eléctrico, luz de borde nítida sobre la carrocería de carbono húmeda",
    "color_palette": "negros mate, grises tormenta, azules eléctricos, reflejos en asfalto mojado, dorado cálido del atardecer",
    "tone": "potencia pura, furia italiana, lujo épico"
  },
  "audio": {
    "music": "tambores cinematográficos profundos y golpes orquestales agresivos con tensión creciente",
    "ambient": "viento aullante de montaña, truenos distantes, lluvia sobre la carretera",
    "sound_effects": "chasquidos metálicos y de carbono secos cuando las piezas encastran, rugido masivo de motor V12 al completarse la forma, gruñido de neumáticos y siseo de lluvia",
    "mix": "potente, atronador, naturaleza contra máquina con un eje musical dominante"
  },
  "constraints": {
    "dialogue": "ninguno",
    "voiceover": "ninguna",
...
```text
Cortometraje cinematográfico de ciencia ficción ultrarrealista, 10 segundos, 16:9. Un joven sorprendentemente apuesto de unos 20 años camina solo por una megaciudad futurista abandonada en el año 2050. Tiene cabello negro azabache, grueso y naturalmente ondulado, ojos marrones oscuros y profundos, mandíbula masculina y afilada, pómulos prominentes y una sutil barba incipiente natural. Viste un elegante abrigo futurista negro, pantalones oscuros y botas minimalistas. La enorme ciudad a su alrededor está completamente desierta: imponentes rascacielos de cristal, autopistas elevadas vacías, vehículos autónomos abandonados, niebla a la deriva, escombros dispersos y tenues luces atmosféricas azules.
0–3 segundos: Toma de seguimiento panorámica y cinematográfica desde atrás mientras camina lentamente por un bulevar futurista vacío, con el eco de sus pasos resonando en la ciudad silenciosa.
3–6 segundos: De repente se detiene y mira hacia arriba. Un anuncio holográfico parpadea y se enciende sobre un rascacielos, luego otro, luego cientos.
6–9 segundos: Miles de gigantescos anuncios holográficos se activan repentinamente en toda la ciudad (carteles de neón, interfaces flotantes, productos animados y mensajes misteriosos), iluminando las calles abandonadas a su alrededor. El rostro del hombre refleja la luz holográfica mientras mira a su alrededor en estado de shock.
9–10 segundos: Primer plano dramático de su rostro mientras cada pantalla holográfica gira simultáneamente hacia él, creando la inquietante certeza de que tal vez no esté realmente solo.
Movimiento humano fotorrealista, física de telas realista, niebla volumétrica cinematográfica, calles húmedas y reflectantes, arquitectura futurista detallada, profundidad atmosférica, destello de lente sutil, brillo holográfico realista, movimiento de cámara dramático, alto contraste, HDR 8K, aspecto cinematográfico anamórfico, atmósfera futurista de suspense, sin dibujos animados, sin rostro con apariencia de IA, sin fallos de texto, sin manos distorsionadas.
```
...
Cine / Fotograma · Renderizado 3D · Personaje · Texto / Tipografía · Publicado
...
### Instrucciones de animación estilo juego de papel 2D conservando el personaje de dibujo infantil.

Autor：[@ikura\_no\_oyaji](https://x.com/ikura_no_oyaji) · [Publicación original](https://x.com/ikura_no_oyaji/status/2101472711335878834)

Anime / Manga · Personaje · Publicado

**Resumen:** Instrucciones de animación estilo juego de papel 2D conservando el personaje de dibujo infantil.

<img src="covers/2101472711335878834.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
No distorsionar ni alterar el personaje adjunto, mantenerlo tal cual.\nJuego de papel 2D.
```
...
### Construir una hermosa mariposa mecánica en Three.js.
...
**Resumen:** Construir una hermosa mariposa mecánica en Three.js.
...
### Crear un recurso 3D del robot WALL-E usando Three.js.
...
**Resumen:** Crear un recurso 3D del robot WALL-E usando Three.js.
...
### Generar un exquisito modelo 3D interactivo de mariposa mecánica en Three.js.

Autor：[@thtbee\_](https://x.com/thtbee_) · [Publicación original](https://x.com/thtbee_/status/2101304547876700627)

Renderizado 3D · Publicado

**Resumen:** Generar un exquisito modelo 3D interactivo de mariposa mecánica en Three.js.

<img src="covers/2101304547876700627.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
crea una hermosa mariposa mecánica en three.js
```
...
### Prompt para generar un dragón interactivo en 3D sobre un fondo blanco usando Three.js.

Autor：[@TimJayas](https://x.com/TimJayas) · [Publicación original](https://x.com/TimJayas/status/2101024701044904074)

Renderizado 3D · Animal / Criatura · Resumen / Antecedentes · Publicado

**Resumen:** Prompt para generar un dragón interactivo en 3D sobre un fondo blanco usando Three.js.

<img src="covers/2101024701044904074.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
crea un dragón en 3D usando three.js, utiliza un fondo de tema blanco para que el objeto principal sea visible
```
...
### Una secuencia animada en 3D de obreros de construcción en miniatura armando una pizza gigante.
...
**Resumen:** Una secuencia animada en 3D de obreros de construcción en miniatura armando una pizza gigante.

<img src="covers/2096885269270237431.jpg" alt="Imagen 1" width="480" />
  ...
  "sequence": [
    {
      "time": "0-2 seg",
      "scene": "Gran montaje",
      "camera": "Toma aérea cinematográfica amplia con acercamiento",
      "action": "Una enorme pizza recién horneada descansa sobre una mesa de madera como si fuera una gigantesca obra de construcción. Decenas de diminutos obreros llegan corriendo con cargadores miniatura, grúas, camiones repartidores y herramientas, preparándose para construir la pizza perfecta.",
      "sound_design": "Música alegre y juguetona, ruidos de motores diminutos, ruedas rodando, sutil actividad de construcción."
    },
    {
      "time": "2-4 seg",
      "scene": "Capa de salsa y queso",
      "camera": "Toma lateral media en seguimiento",
      "action": "Un camión de comida en miniatura bombea una rica salsa roja de tomate sobre la pizza mientras pequeños trabajadores la esparcen suavemente con espátulas pequeñas. Otro equipo los sigue detrás, cubriendo la superficie con una gruesa capa de queso mozzarella rallado.",
      "sound_design": "Vertido suave de salsa, raspado de espátula, crujido de queso, música rítmica y alegre."
    },
    {
      "time": "4-6 seg",
      "scene": "Ingredientes en movimiento",
      "camera": "Acercamiento macro con cámara lenta suave",
      "action": "Diminutas bandas transportadoras trasladan ingredientes coloridos que incluyen pepperoni, champiñones, pimientos, aceitunas y albahaca fresca. Los diminutos obreros acomodan cuidadosamente cada ingrediente sobre la superficie con queso con gran precisión.",
      "sound_design": "Movimiento de banda transportadora, pequeñas caídas de ingredientes, delicados timbres mágicos, alegres acentos musicales."
    },
    {
      "time": "6-8 seg",
      "scene": "Elevación del ingrediente final",
      "camera": "Toma cinematográfica dramática en contrapicado",
      "action": "Una grúa miniatura levanta una rebanada gigante de pepperoni hacia el centro de la pizza. Abajo, los obreros tiran de cuerdas guía y se hacen señas entre sí mientras el ingrediente se coloca lentamente en su lugar.",
      "sound_design": "Motor de grúa pequeña, tensión de cuerdas, clics mecánicos, música orquestal cinematográfica en aumento."
    },
    {
      "time": "8-10 seg",
      "scene": "Gran final de la pizza",
      "camera": "Acercamiento fluido con órbita de 360 grados",
      "action": "El último ingrediente cae a la perfección en su lugar. Una ráfaga de confeti colorido inunda el diminuto mundo mientras los pequeños obreros celebran y vitorean. La cámara recorre la pizza terminada, revelando su brillante queso derretido, ingredientes coloridos y orilla dorada antes de finalizar con una gratificante toma estelar.",
      "sound_design": "Estallido festivo, vítores alegres, silbatos diminutos, cierre orquestal inspirador."
    }
  ],
  "visual_style": {
    "animation_quality": "Animación 3D prémium inspirada en Pixar",
    "world_design": "Encantador mundo de construcción en miniatura edificado alrededor de una pizza gigante",
    "color_palette": "Rojos cálidos, marrones dorados, tonos cremosos de queso e ingredientes brillantes y coloridos",
    "lighting": "Iluminación cálida y dorada suave con sutiles brillos cinematográficos",
    "detail": "Texturas de comida altamente detalladas, maquinaria miniatura, queso derretido realista, ingredientes crujientes y personajes diminutos muy expresivos",
    "camera": "Movimiento cinematográfico fluido, estética de macrofotografía, transiciones suaves, profundidad de campo reducida",
    "overall_feel": "Tierno, juguetón, visualmente satisfactorio, pulido, prémium y fantasioso",
    "resolution": "720p"
  }
}
```
...
### Una obra de arte digital surrealista de un joven con sudadera amarilla sentado sobre una nube.

Autor：[@richardvictor82](https://x.com/richardvictor82) · [Publicación original](https://x.com/richardvictor82/status/2101393659115503783)

Retrato / Selfie · Personaje · Publicado

**Resumen:** Una obra de arte digital surrealista de un joven con sudadera amarilla sentado sobre una nube.

<img src="images/2101393659115503783-1.jpg" alt="Imagen 1" width="480" />

**Prompt**

```text
Una obra de arte digital surrealista de un joven sentado cómodamente en una esponjosa nube blanca en lo alto del cielo, vistiendo una sudadera amarilla con capucha, joggers azules, tenis rojos con blanco y una gorra en tonos pastel.
```
...
### Transformación en cámara rápida de un terreno vacío a una mansión moderna de lujo con piscina de borde infinito bajo iluminación cambiante.
...
**Resumen:** Transformación en cámara rápida de un terreno vacío a una mansión moderna de lujo con piscina de borde infinito bajo iluminación cambiante.
...
```text
Crea un video cinemático en cámara rápida y ultrarrealista de 10 segundos que muestre un terreno de construcción de lujo vacío transformándose rápidamente en una impresionante mansión ultramoderna. Comienza con una parcela de terreno ajardinado completamente vacía bajo una dramática iluminación de hora dorada. En una secuencia de construcción increíblemente rápida y fluida, los cimientos se forman desde el suelo, las estructuras reforzadas se elevan hacia arriba, se ensamblan paredes elegantes, enormes ventanales de vidrio de piso a techo se deslizan perfectamente a su lugar y se completa un sofisticado techo plano. Una impresionante piscina de borde infinito se materializa junto a la casa mientras caminos de piedra y una gran terraza se forman a su alrededor. Rápidamente aparecen céspedes verdes y exuberantes, árboles perfectamente podados, plantas ornamentales y una sutil iluminación de paisaje. Finalmente, toda la propiedad se convierte en una mansión arquitectónica de ultralujo terminada, con una cálida iluminación interior, paredes panorámicas de vidrio, una piscina infinita que refleja la puesta de sol, un paisajismo elegante y una entrada para autos moderna de primera categoría. Termina con un lento acercamiento cinemático de cámara hacia la mansión completada. Materiales fotorrealistas, física de construcción realista, ensamblaje suave de objetos, transformaciones continuas, dramática luz solar volumétrica, reflejos realistas, calidad de visualización arquitectónica, 4K, HDR, profundidad de campo cinematográfica, sin personas, sin texto, sin logotipos, sin marcas de agua. De ritmo rápido pero visualmente fluido, transformación perfectamente continua de terreno vacío a mansión terminada.
```
...
### Pantalla dividida vertical que compara un enfrentamiento terminado con un jaguar en la selva con su contraparte de captura de movimiento en pantalla azul.

Autor：[@abs\_uiux](https://x.com/abs_uiux) · [Publicación original](https://x.com/abs_uiux/status/2099127037352972426)

Otros · Publicado

**Resumen:** Pantalla dividida vertical que compara un enfrentamiento terminado con un jaguar en la selva con su contraparte de captura de movimiento en pantalla azul.
...
Un video en pantalla dividida vertical que compara una toma cinematográfica de VFX con su producción detrás de cámaras. Mitad superior: Una escena de película fotorrealista y de alta resolución con una mujer en forma en una camiseta sin mangas negra y pantalones cargo parada a la defensiva sobre un tronco de madera grueso y cubierto de musgo. Frente a ella, a la izquierda, hay un jaguar enorme y realista que camina lentamente hacia ella a cuatro patas. El fondo es una cascada majestuosa y borrosa con neblina. La iluminación es dramática y cinematográfica. Mitad inferior: La misma escena exacta filmada en un plató con pantalla azul. La misma actriz está parada sobre el mismo tronco de utilería física. En lugar de un jaguar, un actor de captura de movimiento con un traje negro con marcadores blancos y una cámara en el casco gatea a cuatro patas, imitando a la perfección el movimiento del jaguar. El equipo de filmación, las cámaras, los trípodes y los monitores son visibles en primer plano. El fondo azul tiene marcadores de seguimiento rojos. Acción: Tanto el jaguar como el actor de mocap realizan un acecho lento, tenso y sincronizado hacia adelante a lo largo del tronco. La mujer sigue su movimiento con una tensión alerta. Aspectos técnicos: Cámara estática, perfil lateral al nivel de los ojos, enfoque profundo en la parte inferior, profundidad de campo reducida en la parte superior. Alineación perfecta entre el renderizado CGI y el metraje práctico. Estilo fotorrealista, resolución 4k.
```
...
### En una habitación de hotel junto a la playa al atardecer, una mujer de cabello largo en lencería de encaje negro mira por la ventana.

Autor：[@bestcare0221](https://x.com/bestcare0221) · [Publicación original](https://x.com/bestcare0221/status/2097693389672394895)

Personaje · Publicado

**Resumen:** En una habitación de hotel junto a la playa al atardecer, una mujer de cabello largo en lencería de encaje negro mira por la ventana.
...
```text
Al atardecer, en una habitación de hotel con vista a la playa, bajo una luz tenue, una mujer de cabello negro, largo y lacio, de unos 30 años y figura curvilínea, vestida con un conjunto de lencería de encaje negro, está de pie junto a la ventana ladeando la cabeza y mirando hacia la playa exterior.
```
