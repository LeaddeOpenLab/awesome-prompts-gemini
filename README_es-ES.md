...
[Fotografía](#category-photography) · [Cine / Fotograma de película](#category-cinematic-film-still) · [Anime / Manga](#category-anime-manga) · [Ilustración](#category-illustration) · [Render 3D](#category-3d-render) · [Otros](#category-other)
...
### Prompt de retrato de estilo cotidiano de una joven pareja acurrucada en interiores.

Autor：[@55hawks](https://x.com/55hawks) · [Publicación original](https://x.com/55hawks/status/2101199107914424604)

Fotografía · Retrato / Selfie · Personaje · Grupo / Pareja · Arquitectura / Interiorismo · Publicado

**Resumen:** Prompt de retrato de estilo cotidiano de una joven pareja acurrucada en interiores.
...
```text
Una joven pareja enamorada acurrucada en el interior, abrazada por la espalda, con las manos envolviendo suavemente la zona del pecho. Luz natural suave, textura de piel realista, estilo de foto de smartphone --ar 2:3
```
...
### Vídeo macro cinematográfico ultrarrealista de investigadores marinos en miniatura explorando el interior de un canal auditivo humano gigante.
...
**Resumen:** Vídeo macro cinematográfico ultrarrealista de investigadores marinos en miniatura explorando el interior de un canal auditivo humano gigante.
...
```text
Vídeo macro cinematográfico ultrarrealista de una expedición oceánica en miniatura surrealista que se lleva a cabo dentro de una oreja humana gigantesca. Un equipo de diminutos investigadores marinos profesionales con trajes de exploración impermeables navega por las intrincadas curvas del canal auditivo utilizando barcos en miniatura, cuerdas de escalada, escáneres portátiles y equipos científicos compactos. Las estructuras del oído interno parecen enormes como una misteriosa caverna submarina, con textura de piel realista, humedad sutil, vellos finos y detalles anatómicos naturales. Los diminutos investigadores iluminan las paredes con potentes linternas frontales en miniatura mientras otro opera una pequeña sonda robótica que recolecta partículas microscópicas de un charco poco profundo de humedad. Las gotas flotantes se comportan como enormes esferas suspendidas, creando una extraña sensación de escala. Cinematografía macro extrema, profundidad de campo ultrarreducida, anatomía humana realista, dramática iluminación de laboratorio azul y blanca mezclada con cálidas luces de exploración, intrincados detalles en miniatura, reflejos y sombras físicamente precisos, movimiento de cámara cinematográfico lento que viaja a través del canal auditivo hacia las estructuras internas, texturas fotorrealistas, surrealista pero científicamente creíble, 8K, HDR, óptica realista, sin texto, sin marcas de agua. 10 segundos, vertical 9:16.
```
...
### Instrucciones de animación estilo juego de papel en 2D manteniendo el personaje de dibujo infantil.
...
**Resumen:** Instrucciones de animación estilo juego de papel en 2D manteniendo el personaje de dibujo infantil.
...
### Una obra de arte digital surrealista de un hombre joven con sudadera amarilla sentado en una nube.
...
**Resumen:** Una obra de arte digital surrealista de un hombre joven con sudadera amarilla sentado en una nube.
...
```text
Una obra de arte digital surrealista de un hombre joven sentado cómodamente sobre una esponjosa nube blanca en lo alto del cielo, vestido con una sudadera amarilla con capucha, pantalones jogger azules, zapatillas deportivas rojas y blancas y una gorra de color pastel.
```
