# Gemini · Prompt Kütüphanesi · Leadde.ai
...
**27** Prompt · Son eklenen: **2026-09-22**

<a name="catalog"></a>

## Kategoriye göre göz at

[Fotoğrafçılık](#category-photography) · [Sinematik / Film Karesi](#category-cinematic-film-still) · [Anime / Manga](#category-anime-manga) · [İllüstrasyon](#category-illustration) · [3D Modelleme](#category-3d-render) · [Diğer](#category-other)
...
### İç mekânda birbirine sokulan genç bir çiftin günlük tarzda portre istemi.

Yazar：[@55hawks](https://x.com/55hawks) · [Orijinal gönderi](https://x.com/55hawks/status/2101199107914424604)

Fotoğrafçılık · Portre / Selfie · Karakter · Grup / Çift · Mimari / İç Mekan · Yayımlandı

**Özet:** İç mekânda birbirine sokulan genç bir çiftin günlük tarzda portre istemi.

<img src="images/2101199107914424604-1.jpg" alt="Görsel 1" width="480" />

**İstem**

```text
İç mekânda birbirine sokulan genç bir aşık çift, arkadan sarılmış, elleriyle göğüs bölgesini nazikçe sarmalamış. Yumuşak doğal ışık, gerçekçi ten dokusu, akıllı telefon fotoğrafı tarzında --ar 2:3
```
...
### Devasa bir insan kulak kanalının içinde keşif yapan minyatür okyanus araştırmacılarının ultra gerçekçi sinematik makro videosu.

Yazar：[@AiwithBloodline](https://x.com/AiwithBloodline) · [Orijinal gönderi](https://x.com/AiwithBloodline/status/2101892143560437894)

Sinematik / Film Karesi · Manzara / Doğa · Yayımlandı

Orijinal gönderi：[@AiwithBloodline](https://x.com/AiwithBloodline) · [Orijinal gönderi](https://x.com/AiwithBloodline/status/2101618979118658038)

**Özet:** Devasa bir insan kulak kanalının içinde keşif yapan minyatür okyanus araştırmacılarının ultra gerçekçi sinematik makro videosu.

<img src="covers/2101892143560437894.jpg" alt="Görsel 1" width="480" />

**İstem**

```text
Devasa bir insan kulağının içinde gerçekleşen gerçeküstü bir minyatür okyanus keşif gezisinin ultra gerçekçi sinematik makro videosu. Su geçirmez keşif kıyafetleri giymiş küçük profesyonel deniz araştırmacılarından oluşan bir ekip, minyatür tekneler, tırmanma ipleri, taşınabilir tarayıcılar ve kompakt bilimsel ekipmanlar kullanarak kulak kanalının girintili çıkıntılı kıvrımlarında ilerliyor. İç kulak yapıları, gerçekçi cilt dokusu, hafif nem, ince tüyler ve doğal anatomik ayrıntılarla gizemli bir su altı mağarası gibi devasa görünüyor. Küçük araştırmacılar güçlü minyatür kafa lambalarıyla duvarları aydınlatırken, bir diğeri sığ bir nem birikintisinden mikroskobik parçacıklar toplayan küçük bir robotik sondayı yönetiyor. Havada süzülen damlacıklar, asılı kalmış devasa küreler gibi davranarak garip bir ölçek hissi yaratıyor. Aşırı makro sinematografi, ultra sığ alan derinliği, gerçekçi insan anatomisi, sıcak keşif ışıklarıyla harmanlanmış dramatik mavi-beyaz laboratuvar aydınlatması, karmaşık minyatür ayrıntılar, fiziksel olarak doğru yansımalar ve gölgeler, kulak kanalından iç yapılara doğru ilerleyen yavaş sinematik kamera hareketi, fotogerçekçi dokular, gerçeküstü ama bilimsel olarak inandırıcı, 8K, HDR, gerçekçi optikler, metin yok, filigran yok. 10 saniye, dikey 9:16.
```
...
### Çocuk çizimi karakterini koruyan 2D kağıt oyunu tarzı animasyon talimatı.

Yazar：[@ikura\_no\_oyaji](https://x.com/ikura_no_oyaji) · [Orijinal gönderi](https://x.com/ikura_no_oyaji/status/2101472711335878834)

Anime / Manga · Karakter · Yayımlandı

**Özet:** Çocuk çizimi karakterini koruyan 2D kağıt oyunu tarzı animasyon talimatı.

<img src="covers/2101472711335878834.jpg" alt="Görsel 1" width="480" />

**İstem**

```text
Ekli karakteri bozmayın, olduğu gibi koruyun.\n2D kağıt oyunu.
```
...
### Three.js içinde güzel bir mekanik kelebek oluşturun.

Yazar：[@AIBoticssq](https://x.com/AIBoticssq) · [Orijinal gönderi](https://x.com/AIBoticssq/status/2102349105724846399)

3D Modelleme · Yayımlandı

Orijinal gönderi：[@AIBoticssq](https://x.com/AIBoticssq) · [Orijinal gönderi](https://x.com/AIBoticssq/status/2100916466694414727)

**Özet:** Three.js içinde güzel bir mekanik kelebek oluşturun.

<img src="covers/2102349105724846399.jpg" alt="Görsel 1" width="480" />
...
### Three.js kullanarak WALL-E robotunun 3D varlığını oluşturma.
...
**Özet:** Three.js kullanarak WALL-E robotunun 3D varlığını oluşturma.
...
```text
three.js'te wall-e'nin 3D modelini oluşturun.
```
...
### Three.js'te zarif, etkileşimli bir mekanik kelebek 3D modeli oluşturun.

Yazar：[@thtbee\_](https://x.com/thtbee_) · [Orijinal gönderi](https://x.com/thtbee_/status/2101304547876700627)

3D Modelleme · Yayımlandı

**Özet:** Three.js'te zarif, etkileşimli bir mekanik kelebek 3D modeli oluşturun.

<img src="covers/2101304547876700627.jpg" alt="Görsel 1" width="480" />

**İstem**

```text
three.js ile güzel bir mekanik kelebek oluşturun
```
...
### Three.js kullanarak beyaz arka plan üzerinde etkileşimli bir 3D ejderha oluşturma istemi.
...
**Özet:** Three.js kullanarak beyaz arka plan üzerinde etkileşimli bir 3D ejderha oluşturma istemi.
...
```text
three.js kullanarak 3D bir ejderha oluşturun, ana nesnenin görünür olması için beyaz temalı bir arka plan kullanın
```
